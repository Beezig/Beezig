package paulscode.sound.codecs_remap;
...
public class CodecJOrbis implements ICodec {
     ...
     *
     * @param b True if the calling audio library requires byte-reversal from certain codecs_remap
     */
    ...
    public boolean initialize(URL url) {
        ...
        try {
            ...
            urlConnection.addRequestProperty("User-Agent", Log.getUserAgent());
