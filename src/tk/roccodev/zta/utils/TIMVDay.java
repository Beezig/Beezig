...
public class TIMVDay {
	...
	public static Long parseCalendar(Calendar c){
		return Long.parseLong(c.get(Calendar.YEAR) + "" + c.get(Calendar.MONTH) + c.get(Calendar.DAY_OF_MONTH));
	}
	...
	public static boolean containsDayfile(Date date){
		...
		cal.setTime(date);
		String fileName = cal.get(Calendar.YEAR) + "-" + cal.get(Calendar.MONTH) + "-" + cal.get(Calendar.DAY_OF_MONTH);
