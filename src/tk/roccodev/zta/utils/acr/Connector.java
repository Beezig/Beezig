...
public class Connector {
	...
	public static boolean sendReport(String chatReportId, String reason) throws IOException {
		...
		String urlParameters = "category=chat&reason=" + reason + "&comment=&evidence=" + URLEncoder.encode("http://hivemc.com/chatlog/" + chatReportId) + "&UUIDs%5B%5D=" + uuid + "&notify=false&_token=" + reportToken;
		...
		if(conn3.getResponseCode() == 200) return true;
		return false;
