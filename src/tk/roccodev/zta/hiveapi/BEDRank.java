...
public enum BEDRank {
	...
	SLEEPY("Sleepy", 0, 100, 300, 600, 1000),
	SNOOZER("Snoozer", 1500, 2100, 2800, 3600, 4500),
	DROWSY("Drowsy", 5500, 6600, 7800, 9100, 10500),
	SLOTH("Sloth", 12000, 13600, 15300, 17100, 19000),
	HYPNOTIST("Hypnotist", 21000, 23100, 25300, 27600, 30000),
