...
import tk.roccodev.beezig.command.CustomTestCommand;
import tk.roccodev.beezig.command.DebugCommand;
import tk.roccodev.beezig.command.LeaderboardCommand;
import tk.roccodev.beezig.command.MathCommand;
import tk.roccodev.beezig.command.MedalsCommand;
import tk.roccodev.beezig.command.MessageOverlayCommand;
import tk.roccodev.beezig.command.MonthlyCommand;
import tk.roccodev.beezig.command.NotesCommand;
import tk.roccodev.beezig.command.PBCommand;
import tk.roccodev.beezig.command.PlayerStatsCommand;
import tk.roccodev.beezig.command.RanksCommand;
import tk.roccodev.beezig.command.ReVoteCommand;
import tk.roccodev.beezig.command.RealRankCommand;
import tk.roccodev.beezig.command.ReportCommand;
import tk.roccodev.beezig.command.RigCommand;
import tk.roccodev.beezig.command.SayCommand;
import tk.roccodev.beezig.command.SeenCommand;
import tk.roccodev.beezig.command.SettingsCommand;
import tk.roccodev.beezig.command.ShrugCommand;
import tk.roccodev.beezig.command.TokensCommand;
import tk.roccodev.beezig.command.UUIDCommand;
import tk.roccodev.beezig.command.WRCommand;
import tk.roccodev.beezig.command.ZigCheckCommand;
